...
class User:
    ...
    def get_users_by_id_list(self, lst_id):
        self.load_user_list()
        #print(self.users.set_index("userid"))
        return self.users.set_index("userid").loc[lst_id,]

if __name__ == "__main__":

    Usr = User()
    #Usr.generate_user_list()
    print(Usr.get_users_by_id_list([1351, 1419, 1411, 1409, 1408, 1403, 1399, 1382, 1380, 1379]))
